...
import { SortColumn, SortDirection } from '../../books/book-history/sortable.directive';
...
export class CurrentLendingsService {
  ...
  constructor(private pipe: DecimalPipe, private lendingDataService: LendingDataService) {}

  public refresh(lendingHistory: LendingHistory): void {
    this.lendings = lendingHistory.currentLendings;
